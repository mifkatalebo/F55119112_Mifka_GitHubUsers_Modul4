package com.f55119112.mifka_githubusers;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("F55119112_List of Users");
        }
    ...
    private void getListUsers() {
        ...
        client.addHeader("Authorization", "token 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");
